...
(1, 'Erreur critique', 'Alerte sur les erreurs critiques', 'level', '{"level": "error", "count": 1, "timeframe": 300}', 'critical', 1, 1, NOW()),
(2, 'Pic d\'erreurs', 'Alerte sur les pics d\'erreurs', 'level_count', '{"level": "error", "count": 10, "timeframe": 60}', 'high', 1, 1, NOW()),
(3, 'Aucune activité', 'Alerte si aucune activité', 'log_inactivity', '{"level": "info", "count": 0, "timeframe": 3600}', 'medium', 1, 1, NOW());
